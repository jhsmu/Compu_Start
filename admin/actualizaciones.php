            ...
            <form class="w-full" action="../proveedor/guardarProveedor.php" method="post">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        name="proveedor" id="proveedor" type="text" placeholder="Ingrese el proveedor">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                        name="correo" id="correo" type="email" placeholder="Ingrese el Correo">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600"
                        name="direccion_web" id="direccion_web" type="text" placeholder="Ingrese el sitio web">
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        name="direccion" id="direccion" type="text" placeholder="Ingrese la dirección">
                    </div>
                </div>
                <div class="mt-5">
