...
<head>
    ...
    <title>Vista ampliada teclado mecanico</title>
</head>
<body>
    ...
    <div class=" mb-3" style="width: 100%; height: 600px;">
          ...
          <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="./imagenesP/teclado1.webp" class="d-block w-100" alt="" width="350" height="200">
                </div>
                <div class="carousel-item">
                     <img src="./imagenesP/teclado1.2.webp" class="d-block w-100" alt="" width="400" height="400">
                </div>
                <div class="carousel-item">
                     <img src="./imagenesP/teclado1.3.webp" class="d-block w-100" alt="" width="300" height="300">
                </div>
                </div>
        ...
        <div class="col-md-8">
            <div class="card-body">
              <h2 class="card-title" style="margin: 70px 10px ;" name="tecladoMecanicoHyper" id="nombre">Teclado Mecanico HyperX Alloy Origins 65</h5>
              ...
              <p class="card-text">
                ...
                <section id="caracteristicas">
                    ...
                    <ul class="list-group list-group-horizontal-sm">
                        <li class="list-group-item"> <b>Sku</b> </li>
                        <li class="list-group-item">56R64AA</li>
                    </ul>
                    <ul class="list-group list-group-horizontal-sm">
