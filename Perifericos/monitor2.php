...
<head>
    ...
    <title>Vista ampliada monitor vertical</title>
</head>
<body>
    ...
    <div class=" mb-3" style="width: 100%; height: 600px;">
          ...
          <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="./imagenesP/monitor2.webp" class="d-block w-100" alt="" width="900" height="350">
                </div>
                <div class="carousel-item">
                     <img src="./imagenesP/monitor2.4.webp" class="d-block w-100" alt="" width="600" height="400">
                </div>
                <div class="carousel-item">
                     <img src="./imagenesP/monitor2.2.webp" class="d-block w-100" alt="" width="150" height="500">
                </div>
                <div class="carousel-item">
                     <img src="./imagenesP/monitor2.3.webp" class="d-block w-100" alt="" width="600" height="400">
                </div>
            </div>
        ...
        <div class="col-md-8">
            <div class="card-body">
              <h2 class="card-title" style="margin: 70px 10px ;" name="monitorLG27" id="nombre">Monitor LG de 27 pulgadas</h5>
              ...
              <p class="card-text">
                ...
                <li>Tipos de conexión: 2 HDMI 1.4, DisplayPort 1.2, VGA, Jack 3.5 mm.</li>
                <li>Es giratorio y reclinable.</li>
                <li>Comodidad visual en todo momento.</li></p>
                <br>
                ...
                <section id="caracteristicas">
                    ...
                    <ul class="list-group list-group-horizontal-sm">
                        ...
                        <li class="list-group-item">27G2</li>
                    </ul>
                    <ul class="list-group list-group-horizontal-sm">
                    ...
                    <ul class="list-group list-group-horizontal-sm">
                        ...
                        <li class="list-group-item">2 HDMI 1.4</li>
                        <li>DisplayPort 1.2</li>
                        <li>VGA, Jack 3.5 mm</li>
                    </ul>
                    <ul class="list-group list-group-horizontal-sm">
