...
<body>
    ...
    <div class=" mb-3" style="width: 100%; height: 600px;">
          ...
          <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img src="./imagenes/memoria5.webp" class="d-block w-100" alt="" width="900" height="200">
                </div>
            </div>
        ...
        <div class="col-md-8">
            <div class="card-body">
              <h2 class="card-title" style="margin: 70px 10px ;" name="memoriaRAM16gb" id="nombre">Memoria RAM 4gb</h5>
              <p name="precio" id="precio">Precio aquí</p>
              <h3>Características</h3>
              <p class="card-text">
                <li> Optimiza el rendimiento de tu máquina con la tecnología DDR3L.</li>
                <li> Memoria con formato SODIMM.</li>
                <li> Alcanza una velocidad de 1600 MHz.</li>
                <li> Apta para notebooks.</li>
                <li>Cuenta con una tasa de transferencia de 12800 MB/s.</li>
                </p>
                <br>
                ...
                <section id="caracteristicas">
                    ...
                    <ul class="list-group list-group-horizontal-sm">
                        ...
                        <li class="list-group-item"> 4 GB</li>
                    </ul>
                    <ul class="list-group list-group-horizontal-sm">
                        <li class="list-group-item"> <b>Velocidad</b> </li>
                        <li class="list-group-item">1600 MHz</li>
                    </ul>
                    <ul class="list-group list-group-horizontal-sm">
                        <li class="list-group-item"> <b>tecnología</b></li>
                        <li class="list-group-item">DDR3L</li>
                    </ul>
                    <ul class="list-group list-group-horizontal-sm">
